...
class Model():
    ...
    def train(self):
        ...
        # 网格
        grid = self.dataset.grid # (128, 128, 128)
        grid = grid.to(self.Params['Device'])
        grid = grid.unsqueeze(0) # (1, 128, 128, 128)
        print(speed.min())
        #'''
    ...
    def plot(self,epoch,total_train_loss, grid):
        ...
        '''
        X,Y: (80,80) 
        X: [[-0.5    -0.4875 -0.475  ...  0.4625  0.475   0.4875]
        ...
        '''
        XP: (6400, 2*dim) 
        [[ pos[0].      pos[1].      0      -0.5         -0.5      0]
         [ pos[0].      pos[1].      0      -0.4875      -0.5      0]
         [ pos[0].      pos[1].      0      -0.475       -0.5      0]
         ...
         [ pos[0].      pos[1].      0      0.4625      0.4875     0]
         [ pos[0].      pos[1].      0      0.475       0.4875     0]
         [ pos[0].      pos[1].      0      0.4875      0.4875     0]]
        '''
